...
workflow.add_conditional_edges(
    "executor_agent",
    route_after_executor,
    {"executor_agent": "executor_agent", "syntax_tester_agent": "syntax_tester_agent"}
)
workflow.add_conditional_edges(
    "syntax_tester_agent",
    route_after_syntax,
    {"executor_agent": "executor_agent", "runtime_tester_agent": "runtime_tester_agent", "notification_agent": "notification_agent"}
)
workflow.add_conditional_edges(
    "runtime_tester_agent",
    route_after_runtime,
    {"executor_agent": "executor_agent", "functional_tester_agent": "functional_tester_agent", "notification_agent": "notification_agent"}
)
workflow.add_conditional_edges(
    "functional_tester_agent",
    route_after_functional,
    {"executor_agent": "executor_agent", "filesystem_exporter_agent": "filesystem_exporter_agent", "notification_agent": "notification_agent"}
)
...
if __name__ == "__main__":
    print("====================================================")
    print("=== Launching Modularized AI Orchestrator        ===")
    print("====================================================")
